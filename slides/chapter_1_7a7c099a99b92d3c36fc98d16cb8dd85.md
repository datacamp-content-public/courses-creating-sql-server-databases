...
`@script`
Objects can be moved from schema to another in a tranarent manner without the need to drop or create , this can be done by altering the schema destination transfer from source
...
`@script`
Not only tables can be grouped under schema, 
