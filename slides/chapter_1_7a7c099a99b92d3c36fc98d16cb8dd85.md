...
Where you might otherwise have separate databases for different components of a business's operations
...
`@script`
Schemas allow database objects to be organized into a logical group. 
