...
`@script`
To move an existing object to a different schema, you'll alter the schema to include the object
...
`@script`
As in ALTER SCHEMA HumanResources TRANSFER dbo.Employees.
