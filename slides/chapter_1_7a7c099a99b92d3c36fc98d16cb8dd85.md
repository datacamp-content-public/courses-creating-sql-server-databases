...
`@script`
Now we can move an existing table into the schema. We do that with an alter schema statement. I'm going to alter the schema human resources and transfer the dbo.employeestable into it. 
