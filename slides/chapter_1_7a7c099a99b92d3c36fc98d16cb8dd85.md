...
`@script`
you can be moved from schema to another in a tranarent manner without the need to drop then create , this can be done by altering the schema destination transfer from source
