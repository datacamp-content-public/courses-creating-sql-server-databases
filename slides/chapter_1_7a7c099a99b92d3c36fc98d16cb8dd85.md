...
`@script`
Every time we've created a table in this course you might have noticed that SQL Server Management Studio placed the letters D-B-O before the name. I bet you've been wondering what that's all about. test
